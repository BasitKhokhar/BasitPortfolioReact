      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {pricingPlans.map((plan, index) => (
            <div key={index} data-aos="flip-left" className="h-full">
              <div
                className="rounded-xl overflow-hidden transition-all duration-500 hover:shadow-2xl hover:scale-105 transform h-full"
                style={{
